...
f = open('test_test)','w')
for line in lines:
        strategy, response,previous_history = galbackend_online.get_response(line, 'user_id',previous_history,oov_state,name_entity_state,short_answer_state,word2vec_ranking_state,anaphra_state,1)
        f.write('User: '+line)
