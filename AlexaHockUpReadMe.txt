...
6: To start your CMU Magnus, say to your Echo. "Alexa wake up CMU Magnus". If your socket port is denyed, change it to something larger than 1024. You need to do change the corresponding port in the messagem_pass.py as well.
