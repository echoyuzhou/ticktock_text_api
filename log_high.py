...
rating_logs_2 = readall("/home/ubuntu/zhou/Backend/rating_log/v2")
writelist2, num_turns_all_2 = get_log(rating_logs_2)
...
print "the number of peopel who did both tasks"
v1 = set(item[1] for item in num_turns_all)
print v1
v2 = set(item[1] for item in num_turns_all_2)
print v2
v_int = len(v1.intersection(v2))
