...
while True:
	...
	print user_id
        ...
        theme, strategy,response,previous_history = galbackend_online.get_response(user_input_real, user_id,previous_history,theme,oov_state,name_entity_state,short_answer_state,anaphra_state,word2vec_ranking_state,tfidf_state)
